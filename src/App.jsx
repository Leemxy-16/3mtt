...
const techSuggestions = [
  {
    ...
    keyword: ["html", "css", "javascript", "react", "frontend", "front end", "vue", "web design"]
  },
  {
    ...
    keyword: ["back end", "backend", "node", "django", "flask", "express", "api", "sql", "database"]
  },
  {
    ...
    keyword: ["android", "kotlin", "java", "java android", "mobile app", "android studio"]
  },
  {
    skill: "Mobile App Development (iOS)",
    months: 7,
    note: "Swift and Xcode are the essentials. Try building a weather or notes app.",
    keyword: ["ios", "swift", "xcode", "apple", "iphone", "ipad"]
  },
  {
  ...
  },
  {
    ...
    keyword: ["cybersecurity", "security", "hacking", "ethical hack", "pentest", "penetration test", "ctf"]
  },
  {
    ...
    keyword: ["data science", "python", "machine learning", "ml", "ai", "artificial intelligence", "pandas", "scikit", "tensorflow"]
  },
  {
  ...
  },
  {
    ...
    keyword: ["game development", "unity", "c#", "godot", "unreal", "game dev"]
  }
];
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 p-4">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        ...
        <textarea
          ...
          className="w-full resize-none p-3 border border-gray-300 rounded-md text-gray-900 mb-4 focus:outline-none focus:ring-2 focus:ring-blue-400 bg-gray-50"
          rows={4}
        />
      ...
      {suggestions.length > 0 && (
        <div className="mt-8 max-w-3xl mx-auto grid gap-6">
          {suggestions.map((suggestion, index) => (
            <div
              key={index}
              className="border-2 border-blue-100 bg-white rounded-xl shadow p-6"
            >
